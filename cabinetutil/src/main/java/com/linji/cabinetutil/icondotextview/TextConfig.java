...
//    public TextConfig(Context context, TypedArray typedArray) {
//        DEFAULT_SIZE = IconDotTextView.sDefaultDotTextSize;
//        if (typedArray != null) {
//            mSize = typedArray.getDimensionPixelSize(R.styleable.IconDotTextView_dot_size, DEFAULT_SIZE);
//            mColorStateList = typedArray.getColorStateList(R.styleable.IconDotTextView_dot_textColor);
//            if (mColorStateList == null) {
//                mColorStateList = ColorStateList.valueOf(DEFAULT_COLOR);
//            }
//            mText = typedArray.getString(R.styleable.IconDotTextView_dot_text);
//        }
//        init();
//    }
