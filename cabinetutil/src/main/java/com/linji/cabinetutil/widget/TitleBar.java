...
//        mLeftText.setCompoundDrawablesWithIntrinsicBounds(resId, 0, 0, 0);
    ...
    public void setLeftImageResource(int resId,int size) {
        ...
        drawable.setBounds(0, 0, ScreenUtil.dip2px(getContext(), size), ScreenUtil.dip2px(getContext(), size));
        mLeftText.setCompoundDrawables(drawable, null,null,null);
    }
    public void setLeftImageResource(int resId,int width,int height) {
        Drawable drawable = getResources().getDrawable(resId);
        drawable.setBounds(0, 0, ScreenUtil.dip2px(getContext(), width), ScreenUtil.dip2px(getContext(), height));
        mLeftText.setCompoundDrawables(drawable, null,null,null);
    }
    ...
    private View inflateAction(Action action) {
        ...
        if (view instanceof ImageView){
            ...
            ((TextView) view).setTextSize(DEFAULT_ACTION_TEXT_SIZE);
            if (mActionTextColor != 0) {
                ((TextView) view).setTextColor(mActionTextColor);
            }
            view.setPadding(mActionPadding, 0, mActionPadding, 0);
        }else if (view instanceof BorderTextView){
            ((BorderTextView) view).setGravity(Gravity.CENTER);
            ((BorderTextView) view).setTextSize( DEFAULT_ACTION_TEXT_SIZE);
            if (mActionTextColor != 0) {
                ((BorderTextView) view).setTextColor(mActionTextColor);
            }
            view.setPadding(mActionPadding, mActionPadding * 2, mActionPadding, mOutPadding * 2);
        }
        view.setTag(action);
